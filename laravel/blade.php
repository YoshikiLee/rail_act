...
class Blade {
	 ...
	 * @return string
	 */
	protected static function compile_yieldContents($value)
	{
	...
	/**
	 * Rewrites Blade yieldContent section statements into valid PHP.
	 *
	 * @return string
	 */
	protected static function compile_yieldContent_sections($value)
	{
		$replace = '<?php echo \\Laravel\\Section::yieldContent_section(); ?>';

		return str_replace('@yieldContent_section', $replace, $value);
	}
